...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.areas.update' , $area ) }}' >
					@csrf
					@method('PATCH')
					<div class="card-header bg-primary">
						<h3 class="card-title text-white"> تعديل بينات المنطقه </h3>
					</div>
					<div class="card-body">
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<div>
								<label class="form-check">
									<input class="form-check-input" name='active' type="checkbox" {{ $area->is_active == 1 ? 'checked': '' }}>
