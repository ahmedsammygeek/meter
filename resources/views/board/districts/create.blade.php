...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.districts.store') }}' >
					@csrf
					<div class="card-header bg-primary">
						<h3 class="card-title text-white"> إضافه حى جديد </h3>
					</div>
					<div class="card-body">
						<div class="mb-3">
						...
						<div class="mb-3">
							<label class="form-label required"> اسم الحى </label>
							<div>
