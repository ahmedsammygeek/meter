...
<head>
  ...
  <link rel="stylesheet" href="{{ Storage::url('sweetalert2.min.css') }}">
  @livewireStyles
  @yield('styles')

</head>
<body >
  <script src="{{ Storage::url('board_assets/dist/js/demo-theme.min.js') }}"></script>
  <div class="page">
    <!-- Navbar -->
 ...
 <script src="{{ Storage::url('board_assets/dist/js/tabler.min.js') }}" defer></script>
 <script src="{{ Storage::url('board_assets/dist/js/demo.min.js') }}" defer></script>
 {{-- <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script> --}}
 <script src="{{ Storage::url('board_assets/dist/js/sweetalert2.min.js') }}"></script>
